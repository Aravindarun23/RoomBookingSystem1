...
<body>
	...
	AdminEditRoom editroom = new AdminEditRoom(DBConnect.getcon());
	...
	<div class="container">
		<div class="form">
			...
			<form method="post" action="AdminEditRoomServlet?id=<%=id%>">
				...
				<div class="input-area">
					<span>Total Rooms : </span><input type="text" placeholder="Availablity Of Room"
						name="availablityofrooms"
						value="<%=room.getAvailablityofrooms()%>"> 
				</div>
				<div class="input-area">
				...
				<div class="input-area">
					<span>Room Image : </span><input type="text" placeholder="Room Image" name="roomimage"
