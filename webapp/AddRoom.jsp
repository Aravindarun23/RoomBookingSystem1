	...
	<div class="container">
		<div class="form">
			...
			<form method="post" action="AdminAddRoomServlet">
				...
				<div class="input-area">
					<span>Total Rooms : </span><input type="text"
						placeholder="Availablity Of Room" name="availablityofrooms">
				</div>
				<div class="input-area">
					<span>Price : </span><input type="number" placeholder="Cost"
						name="cost">
				</div>
				<div class="input-area">
					<span>Room Image : </span><input type="text"
						placeholder="Room Image" name="roomimage">
				</div>
				<div class="button">
