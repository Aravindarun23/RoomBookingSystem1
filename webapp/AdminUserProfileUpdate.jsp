...
UserDetails profile=UserDetailsEdit.editUserdetails(userid);
%>
	<div class="container">
		<div class="form">
			<span class="title">Profile Update</span>
			<form method="post" action="UserDetailsEditServlet?id=<%=userid%>">
			<div class="input-area">
				...
				<a href="UserDetailsAdmin.jsp" class=signup-text>
